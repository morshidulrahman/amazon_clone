...
const AllPage = () => {
  ...
  useEffect(() => {
    ...
    setproducts(
      ProductsData.filter((item) => item.category === selectcategory)
    );
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="bg-[#E5E7EB] h-52 flex items-center justify-center font-bold">
        ...
        <p className="text-orange-500 capitalize font-bold ml-1">
          {" "}
          all products
        </p>
      </div>
      <main className="max-w-screen-2xl mx-auto">
        <div className="grid md:grid-cols-4 grid-cols-1 gap-2 py-9">
          ...
          <Leftpage
            category={category}
            categoryhandeler={categoryhandeler}
